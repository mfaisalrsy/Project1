                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="kategori" name="kategori" class="custom-select">
                                            <option value="Spesialis Anak">Umum</option>
                                            <option value="Penyakit Dalam">Spesialis</option>
                                            <option value="Kulit dan Kelamin">Bidan</option>
                                            <option value="Kesehatan Jiwa">Dokter Gigi</option>
                                            <option value="Spesialis Saraf">Anastesi</option>
                                            <option value="Gigi">Bedah</option>
                                            <option value="Bedah">Ginekologi</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
