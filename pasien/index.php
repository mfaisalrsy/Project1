                            ...
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='edit.php?id=" . $row['id'] . "'><button class='btn btn-warning btn-sm mr-1'>Edit</button></a>";
                                        echo "<span class='mx-1'></span>"; 
                                        echo "<a href='delete.php?id=" . $row['id'] . "' onclick='return confirm(\"Yakin Hapus Data?\")'><button class='btn btn-danger btn-sm'>Delete</button></a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
